...
export default function Navbar() {
  ...
  const { isAuthenticated, user } = useSelector((state) => state.auth.value);
      ...
      <div className="container">
        ...
        <nav className="header__menu">
          {isAuthenticated ? (
            <div className="header__user">
              ...
              <button
                ...
                onClick={() => dropdownMenu.classList.toggle('show')}
              >
                <svg
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="dropdown-menu">
            {isAuthenticated ? (
              <Link to={`/edit-profile/${user._id}`} className="dropdown-link">
                <svg
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
